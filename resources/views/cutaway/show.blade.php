...
{{--                        </svg>--}}
                ...
                @else
                    <a href="{{ route('login') }}" title="">
                        <svg style="height: 35px" aria-hidden="true" focusable="false" data-prefix="fa-light"
                             data-icon="right-to-bracket" class="svg-inline--fa fa-right-to-bracket fa-w-16" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                ...
                <div class="cutaway-avatar m-auto">
                    <div>
                        @if ($user->profile->user_img)
                            <img src="{{ asset($user->profile->user_img) }}" alt="Photo">
                        @else
                            <img src="{{ asset('user_img/no_img.png') }}" alt="Photo">
                        @endif
                    </div>
                </div>
